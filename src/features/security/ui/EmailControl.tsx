  ...
  return (
    <Disclosure>
      {({ close }) => {
        ...
        return (
          <form onSubmit={(data) => void handleSubmit(onSubmit)(data)} className="flex flex-col items-start">
            <LabeledInput
            ...
            <Disclosure.Button onClick={handleEmailChanging} as="div">
              <Button
                type="button"
                extraClass={`mt-5 text-[18px] font-semibold ${isEmailChanging ? "text-secondary-600" : "text-main-violet-600"}`}
