...
import {EVENTS_TAG, FOLLOW_TAG, PARTICIPANTS_TAG, PROFILE_TAG, SESSION_TAG} from './tags'
...
export const baseApi = createApi({
  tagTypes: [SESSION_TAG, PROFILE_TAG, PARTICIPANTS_TAG, EVENTS_TAG, FOLLOW_TAG],
  reducerPath: 'api',
